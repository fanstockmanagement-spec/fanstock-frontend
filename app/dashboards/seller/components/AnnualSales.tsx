...
export default function AnnualSales() {
    ...
    const { annualSalesData, isLoadingAnnualSales, refetchAnnualSales } = useAnnualSales(selectedYear);

    const handleYearChange = (year: number) => {
        setSelectedYear(year);
        refetchAnnualSales(year);
    };
    ...
    return (
        <div className="p-6 text-sm">
            <h1 className="text-2xl font-medium mb-4">Annual Sales Analytics</h1>
            ...
            {isLoadingAnnualSales && (
                <div className="text-center py-8">
                    ...
                    <p className="mt-2 text-gray-600">Loading annual sales...</p>
                </div>
            )}

            {/* Analytics Dashboard */}
            {!isLoadingAnnualSales && annualSalesData && (
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full">
                                ...
                                <tbody className="bg-white divide-y divide-gray-200">
                                    {annualSalesData.sales_by_shoe?.map((shoe) => (
                                        <tr key={shoe.shoe_id}>
                    ...
                    <div className="bg-white border border-gray-200 rounded-lg overflow-clip">
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full">
                                ...
                                <tbody className="bg-white divide-y divide-gray-200">
                                    {annualSalesData.daily_breakdown?.map((day, index) => (
                                        <tr key={index}>
                    ...
                    <div className="bg-white border border-gray-200 rounded-lg overflow-clip">
                        ...
                        <div className="p-4">
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                {annualSalesData.sales_by_category ? Object.entries(annualSalesData.sales_by_category).map(([category, data]) => (
            ...
            {!isLoadingAnnualSales && !annualSalesData && (
                <div className="text-center py-8">
                    <p className="text-gray-500">No sales data found for {selectedYear}</p>
                </div>
            )}
        </div>
    )
